import{Base,Polymer,html$1 as html,PolymerElement,html as html$1}from"./tr-app.js";const $_documentContainer=document.createElement("template");$_documentContainer.setAttribute("style","display: none;");$_documentContainer.innerHTML=`<dom-module id="app-grid-style">
  <template>
    <style>
      :host {
        /**
...
</dom-module>`;document.head.appendChild($_documentContainer.content);Polymer({is:"iron-request",hostAttributes:{hidden:!0},properties:{/**
